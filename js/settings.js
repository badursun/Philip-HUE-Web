...
var settings = {    
    ...
    init: function(){
        var element = document.getElementById('fixed_panel');
        ...
        // Layout Save & Restore
        // if ( !sessionStorage.getItem("s_layout") || $("option:selected", settings.vars.s_layout).val() !=sessionStorage.getItem("s_layout") ){  
        //     console.log('s_layout=>callBack')      
        //     settings.settings_s_layout( sessionStorage.getItem("s_layout") );
        // }

    },
    settings_s_layout: function(tipi){
            if(tipi === "default"){
    ...
    add_events: function(){
        ...
        settings.vars.s_layout.addEventListener("change",function(e){
            // Kayıt
            console.log('s_layout=>Kayıt Edildi')
            sessionStorage.setItem("s_layout", e.target.value); 
            // Trigger
            settings.settings_s_layout(e.target.value);
        });
...
document.addEventListener("DOMContentLoaded", function () {
    if( $('[data-encyrption="true"]').length ){
        settings.init();
    }
});